...
const { getReceived, getSent, getRequest, acceptFriendRequest, declineFriendRequest, cancelFriendRequest, unfriend } = require('../controllers/friendRequestController')
